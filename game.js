...
const levels = [
  {
    name: "Adjectives 1",
    vocabulary: [
      {question: "abenteuerlustig", answers: ["adventurous"]},
      {question: "groß", answers: ["big"]},
      {question: "bitter", answers: ["bitter"]},
      {question: "federnd", answers: ["bouncy"]},
      {question: "mutig", answers: ["brave"]},
      {question: "holprig", answers: ["bumpy"]},
      {question: "bunt", answers: ["colorful"]},
      {question: "kreativ", answers: ["creative"]},
      {question: "knusprig", answers: ["crunchy"]},
      {question: "kuschelig", answers: ["cuddly"]},
      {question: "neugierig", answers: ["curious"]},
      {question: "lecker", answers: ["delicious"]},
      {question: "aufgeregt", answers: ["excited"]},
      {question: "faszinierend", answers: ["fascinating"]},
      {question: "heftig", answers: ["fierce"]},
      {question: "flauschig", answers: ["fluffy"]},
      {question: "freundlich", answers: ["friendly"]},
      {question: "fusselig", answers: ["fuzzy"]},
      {question: "sanft", answers: ["gentle"]},
      {question: "gigantisch", answers: ["gigantic"]},
    ]
  },
  {
    name: "Adjectives 2",
    vocabulary: [
      {question: "leuchtend", answers: ["glowing"]},
      {question: "dankbar", answers: ["grateful"]},
      {question: "glücklich", answers: ["happy"]},
      {question: "hart", answers: ["hard"]},
      {question: "Küche", answers: ["kitchen"]},
      {question: "lebhaft", answers: ["lively"]},
      {question: "lang", answers: ["long"]},
      {question: "laut", answers: ["loud"]},
      {question: "magisch", answers: ["magical"]},
      {question: "melodisch", answers: ["melodic"]},
      {question: "matschig", answers: ["muddy"]},
      {question: "mysteriös", answers: ["mysterious"]},
      {question: "laut", answers: ["noisy"]},
      {question: "oval", answers: ["oval"]},
      {question: "verspielt", answers: ["playful"]},
      {question: "ruhig", answers: ["quiet"]},
      {question: "rechteckig", answers: ["rectangular"]},
      {question: "rau", answers: ["rough"]},
      {question: "rund", answers: ["round"]},
      {question: "traurig", answers: ["sad"]},
    ]
  },
  {
    name: "Adjectives 3",
    vocabulary: [
      {question: "salzig", answers: ["salty"]},
      {question: "verängstigt", answers: ["scared"]},
      {question: "glänzend", answers: ["shiny"]},
      {question: "kurz", answers: ["short"]},
      {question: "albern", answers: ["silly"]},
      {question: "klein", answers: ["small"]},
      {question: "glatt", answers: ["smooth"]},
      {question: "weich", answers: ["soft"]},
      {question: "sauer", answers: ["sour"]},
      {question: "sprudelnd", answers: ["sparkling"]},
      {question: "scharf", answers: ["spicy"]},
      {question: "quadratisch", answers: ["square"]},
      {question: "quietschend", answers: ["squeaky"]},
      {question: "sternförmig", answers: ["star-shaped"]},
      {question: "sonnig", answers: ["sunny"]},
      {question: "süß", answers: ["sweet"]},
      {question: "groß", answers: ["tall"]},
      {question: "dreieckig", answers: ["triangular"]},
      {question: "gerade", answers: ["straight"]},
      {question: "gerade Zahl", answers: ["even"]},
      {question: "ungerade Zahl", answers: ["odd"]},
      {question: "positiv", answers: ["positive"]},
      {question: "negativ", answers: ["negative"]},
      {question: "schwere Last", answers: ["heavy"]},
      {question: "schweres Problem", answers: ["difficult"]},
      {question: "einfaches Problem", answers: ["easy"]},
      {question: "einfache Frage", answers: ["simple"]},
      {question: "kompliziert", answers: ["complicated"]},
    ]
  },
];
